...
const InputData = () => {
  ...
  const userData = async () => {
    ...
    try {
      if (token) {
        const res = await axios.get('https://eb0c3df2296c.ngrok-free.app/auth/me', {  
          headers: { 
        ...
        try {
          const dataResponse = await axios.get(`https://eb0c3df2296c.ngrok-free.app/data/ambildata/${pengguna.nik}`, {
            headers: {
              'Authorization': `Bearer ${token}`
            }
          });
  ...
  const fetchData = async (id) => {
    try {
      const res = await axios.get(`https://eb0c3df2296c.ngrok-free.app/data/ambildata/${id}`, {  // Perbarui URL jika perlu
        headers: {
  ...
  const onSubmit = async () => {
    ...
    const endpoint = isEditing ? 
      `https://eb0c3df2296c.ngrok-free.app/data/editdata/${dataId}` :  // Perbarui URL jika perlu
      "https://eb0c3df2296c.ngrok-free.app/data/tambahdata";  // Perbarui URL jika perlu
